...
<head>
    ...
    <link rel="stylesheet" href="../../assets/styles/booking.css?v=1.7">
    ...
    <div id='main'>
            ...
            <nav id='navbar'>
                ...
                <div id='link_wrapper'> 
                    <ul>
                        ...
                        <li>
                            <a href="../../component/faq" id='active'>FAQ</a>
                        </li>
                        <!-- User -->
                        <li>
        ...
        <div id="faq_cont">
            <form action="#" method="post">
                <input type="text"  name='faq' placeholder="Enter Your FAQ Message">
